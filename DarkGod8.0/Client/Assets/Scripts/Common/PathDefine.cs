...
public class PathDefine
{
    ...
    #endregion
    #region Chat
    public const string SpType1 = "ResImages/btntype1";
    public const string SpType2 = "ResImages/btntype2";

    #endregion

    #region Strong
    public const string ItemArrorBG = "ResImages/btnstrong";
    public const string ItemPlaneBG = "ResImages/charbg3";
    ...
    public const string SelfIcon = "ResImages/3";
