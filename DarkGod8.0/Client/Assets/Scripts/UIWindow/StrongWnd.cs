...
public class StrongWnd : WindowRoot
{
    ...
    private void RefreshItem()
    {
        ...
        if (nextSd != null)
        {
            ...
            SetText(propHP2, "强化 +" + nextSd.addhp);
            SetText(propHurt2, "强化 +" + nextSd.addhurt);
            SetText(propDef2, "强化 +" + nextSd.adddef);

            SetText(txtNeedLv, "需要等级： " + nextSd.minlv);
            SetText(txtNeedCoin, "需要消耗：       " + nextSd.coin);
